      ...
      <Grid container xs={12} spacing={6} item>
        <Grid xs={4} item>
          ...
          {applaudReceivedQuery &&
            applaudReceivedQuery.data &&
            applaudReceivedQuery.data.applaud &&
            applaudReceivedQuery.data.applaud.nodes &&
        ...
        <Grid xs={4} item>
          ...
          {applaudGivenQuery &&
            applaudGivenQuery.data &&
            applaudGivenQuery.data.applaud &&
            applaudGivenQuery.data.applaud.nodes &&
        ...
        <Grid xs={4} item>
          ...
          {applaudStreamQuery &&
            applaudStreamQuery.data &&
            applaudStreamQuery.data.applaud &&
            applaudStreamQuery.data.applaud.nodes &&
